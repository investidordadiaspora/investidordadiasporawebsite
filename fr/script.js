document.addEventListener('DOMContentLoaded', () => {
    ...
    if (hamburger) {
        ...
        hamburger.setAttribute('aria-label', 'Ouvrir/Fermer la navigation');
    ...
    if(modal) {
        ...
        downloadForm.addEventListener('submit', (event) => {
            ...
            console.log(`Email capturé : ${email}, Langue : ${lang}`);
            
            // Enhanced success message with animation
            formMessage.textContent = 'Merci ! Votre téléchargement commencera sous peu.';
    ...
    if (principiosImg) {
        principiosImg.addEventListener('load', () => {
            ...
            console.log('[Principes] Image chargée :', principiosImg.currentSrc, principiosImg.naturalWidth + 'x' + principiosImg.naturalHeight);
        });
        principiosImg.addEventListener('error', () => {
            console.error('[Principes] Échec du chargement de l\'image au chemin :', principiosImg.getAttribute('src'));
            principiosImg.style.background = '#fee';
            principiosImg.style.border = '1px solid #f99';
            principiosCaption.textContent = 'Échec du chargement de l\'image (vérifiez le chemin : ./images/visual-selection.png)';
        });
    }
    ...
    const OPPS = {
      ...
      'turismo': { 
        title: 'Tourisme',
        text: 'Le pays présente des opportunités significatives en écotourisme, tourisme d\'aventure, tourisme culturel et infrastructure hôtelière. Il y a un grand potentiel pour le développement d\'expériences authentiques et d\'activités de loisirs qui répondent au public international, ainsi que l\'expansion de l\'offre d\'hébergements et de services qui répondent à la demande croissante.',
      ...
      'economia-azul': { 
        ...
        text: 'La pêche et la transformation du poisson sont des secteurs stratégiques, avec une production annuelle supérieure à 25.000 tonnes et un potentiel au-dessus de 34.000 tonnes.\n\nLa modernisation des infrastructures de pêche et le développement de nouvelles chaînes de valeur rend ce secteur attractif pour les investisseurs intéressés par l\'exportation, la fourniture au secteur hôtelier national et la diversification de l\'industrie du poisson.',
    ...
    const sdgData = {
        1: {
            title: "Éradication de la Pauvreté",
            description: "Permet directement et indirectement l'accès des hommes et des femmes aux ressources économiques et à la protection sociale.",
            hasImage: true
        },
        2: {
            title: "Faim Zéro et Agriculture Durable", 
            description: "Contribue à l'accès à l'alimentation et à la réduction de la faim. Offre de produits nutritifs et sécurisés.",
            hasImage: true
        },
        3: {
            title: "Santé et Bien-être",
            description: "Accès à des services essentiels pour la qualité de vie des collaborateurs. Exigence dans la chaîne d'approvisionnement de conditions de travail en environnement sain et sécurisé.",
            hasImage: true
        },
        4: {
            title: "Éducation de Qualité",
            description: "Opportunités d'accès à l'éducation et au développement pour les employés, leurs familles et les communautés environnantes.",
            hasImage: true
        },
        5: {
            title: "Égalité des Sexes",
            description: "Stimule la participation pleine et effective des femmes et l'égalité des opportunités. Favorise l'occupation de femmes à des postes de direction.",
            hasImage: true
        },
        6: {
            title: "Eau Potable et Assainissement",
            description: "Contribue à la qualité de l'eau et favorise l'utilisation efficace de la ressource hydrique.",
            hasImage: true
        },
        7: {
            title: "Énergie Propre et Abordable",
            description: "Adoption de sources renouvelables et incorporation de technologies pour augmenter l'efficacité énergétique de son processus productif.",
            hasImage: true
        },
        8: {
            title: "Travail Décent et Croissance Économique",
            description: "Génération d'emploi décent et de revenus. Incitation au travail décent dans la chaîne de valeur. Stimulation de l'entrepreneuriat dans la communauté.",
            hasImage: true
        },
        9: {
            title: "Industrie, Innovation et Infrastructure",
            description: "Promotion de l'industrialisation inclusive et durable. Modernisation de l'infrastructure. Promotion de la technologie, de la recherche et de l'innovation.",
            hasImage: true
        },
        10: {
            title: "Réduction des Inégalités",
            description: "Stimulation de l'autonomisation et promotion de l'inclusion sociale et économique.",
            hasImage: true
        },
        11: {
            title: "Villes et Communautés Durables",
            description: "Promotion de la protection et de la sauvegarde du patrimoine culturel et naturel du monde.",
            hasImage: true
        },
        12: {
            title: "Consommation et Production Responsables",
            description: "Gestion durable et utilisation efficace des ressources naturelles dans la production. Réduction du gaspillage alimentaire. Réalisation d'achats durables.",
            hasImage: true
        },
        13: {
            title: "Action contre le Changement Climatique Mondial",
            description: "Optimisation du processus pour la réduction des émissions de GES.",
            hasImage: true
        },
        14: {
            title: "Vie Sous-Marine",
            description: "Réalisation de campagnes pour la conservation de la zone côtière.",
            hasImage: true
        },
        15: {
            title: "Vie Terrestre",
            description: "Préservation de fragments forestiers, y compris dans les zones montagneuses et de terres arides.",
            hasImage: true
        },
        16: {
            title: "Paix, Justice et Institutions Efficaces",
            description: "Agit contre la corruption et la subornation sous toutes ses formes.",
            hasImage: true
        },
        17: {
            title: "Partenariats et Moyens de Mise en Œuvre",
            description: "Incitations et promotion de partenariats pour le développement durable.",
            hasImage: true
        }
    };
    ...
    if (sdgWheel) {
        ...
        const showSDGInfo = (goalNumber) => {
            ...
            sdgInfoContainer.innerHTML = `
                <div class="sdg-info-content">
                    <h4>ODD ${goalNumber}: ${data.title}</h4>
            ...
            sdgInfoContainer.setAttribute('aria-label', `ODD ${goalNumber}: ${data.title}`);
        };
        ...
        sdgWheel.setAttribute('aria-label', 'Roue interactive des Objectifs de Développement Durable');
